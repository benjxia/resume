...
\section{Education}
  ...
  \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Courses}{: AI/Machine Learning, Deep Learning, Computer Vision, Recommender Systems, Operating Systems, Computer Security, Algorithms, Systems Programming, Data Structures, Software Engineering, Computer Architecture, Computer Graphics, Database Systems } \\
    }}
 \end{itemize}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Libraries/Frameworks}{: React, Node.js, ASP.NET, NumPy, PyTorch, OpenCV, scikit-learn, OpenGL, Robot Operating System 2 (ROS2)} \\
