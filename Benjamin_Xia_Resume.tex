...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \altSubheading
      {UC San Diego CSE Department}{Undergraduate Researcher/Developer}{February 2023 -- June 2024}
      \resumeItemListStart
...
%-------------------------------------------
    \altSubheading
    {UC San Diego CSE Department}{Undergraduate Tutor}{September 2022 -- June 2024}
      \resumeItemListStart
        \resumeItem{Guided \textbf{1000+} students in mastering Python, C, and ARM Assembly programming, and tools such as Git, and Bash. }
        \resumeItem{Instructed \textbf{advanced algorithms}, \textbf{operating systems}, classical artificial intelligence, machine learning theory and implementation with optimization mathematics, scikit-learn, and \textbf{PyTorch}. }
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      %   \resumeItemListStart
      %     \resumeItem{ Four Seasons is a real-time 2 versus 2 3D capture-the-flag shooter game. }
      %     \resumeItem{ Designed and implemented a custom graphics engine, with support for textures, animations, shadow maps, non-photorealistic rendering, dynamic lighting/environments, and particles. }
      %     \resumeItemListEnd
      \resumeProjectHeading
