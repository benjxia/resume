...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{ Increased live preview performance by \textbf{150\%} (frames per second) on Android devices, significantly enhancing app responsiveness and user experience by reducing micro-stutters. }
