...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{ Increased live preview performance by \textbf{200+\%} (frames per second) on Android devices, significantly enhancing app responsiveness and user experience by reducing micro-stutters and optimizing GPU kernels. }
      \resumeItem{ Optimized real-time \textbf{Gaussian splat} training and rendering by multithreading and switching to raster-based splat rendering, simultaneously improving overall performance and scene reconstruction quality by enabling greater frame processing. }
