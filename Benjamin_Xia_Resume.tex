...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{ Partnered with UX designers to develop an intuitive \textbf{augmented reality} 3D space scanning preview by writing custom shaders and points of interest detection, allowing users to easily identify under-reconstructed areas in real-time during scans. }
    \resumeItemListEnd
    \altSubheading
