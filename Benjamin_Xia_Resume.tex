...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{ Refined the design and added support for time-sensitive notifications for an app with \textbf{200 million+} users, enabling critical alerts to bypass Do Not Disturb settings with \textbf{AWS SNS, Java} and \textbf{Swift}. }
