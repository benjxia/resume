...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Enhanced modem/network security by updating interfaces to utilize new SSL certificates from key swap tool.}
    ...
    \altSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Mentored younger members of AI lab by teaching ML and delivering intuitive presentations of ML research papers. }
...
%-------------------------------------------
    ...
    {UC San Diego CSE Department}{Undergraduate Tutor}{September 2022 -- Present}
      \resumeItemListStart
        \resumeItem{Instructed \textbf{1000+} students in Python, C, ARM Assembly, Git, algorithm design paradigms, \textbf{operating systems}, and topics in machine learning ranging from classical models with \textbf{scikit-learn} to deep neural networks with \textbf{PyTorch}.}
        \resumeItem{Identified and \textbf{patched security vulnerabilities} for programming assignment autograders on Gradescope, completely eliminating most student autograder exploits.}
    ...
    \altSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Wrote automated SQL scripts/queries for fetching/compiling data across multiple databases for dashboard.}
      \resumeItemListEnd
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Ranked among the \textbf{top 0.6\%} participants in machine learning competition in both regression and classification tasks.}
          \resumeItemListEnd
      \resumeProjectHeading
